"""Qrent Agent graph (LangGraph).

This module defines the orchestration loop used by the FastAPI app:
retrieval (RAG) -> agent (LLM w/ tools) -> tool execution -> agent -> ...
It binds all registered tools, validates tool arguments, and streams events.
"""
