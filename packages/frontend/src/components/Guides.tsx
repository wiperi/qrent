  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredArticles.map((guide, index) => (
          <a
            key={index}
            href={guide.url}
          ...
          >
            {/* Recommended Flag */}
            {guide.recommended && (
              <div className="relative top-0 right-0 bg-blue-primary text-right text-white text-sm font-bold px-3 py-1 rounded-bl-lg shadow-md">
                推荐
              </div>
            )}
